...
void TestFindNameByPrefix() {
    ...
    ASSERT_EQUAL(get_names(book.FindByNamePrefix("Iv")),
                 (vector<string>{"Ivan Ivanov", "Ivan Petrov", "Ivan Vasiliev"}));
    ASSERT_EQUAL(get_names(book.FindByNamePrefix("Ivan Ivan")),
                 (vector<string>{"Ivan Ivanov"}));
    ASSERT_EQUAL(get_names(book.FindByNamePrefix("Vas")),
                 (vector<string>{"Vasilisa Kuznetsova", "Vasiliy Ivanov",
                                 "Vasiliy Petrov", "Vassisualiy Lokhankin"}));
    ASSERT_EQUAL(get_names(book.FindByNamePrefix("Vasili")),
                 (vector<string>{"Vasilisa Kuznetsova", "Vasiliy Ivanov",
                                 "Vasiliy Petrov"}));
    ASSERT_EQUAL(get_names(book.FindByNamePrefix("Vasiliy")),
                 (vector<string>{"Vasiliy Ivanov", "Vasiliy Petrov"}));
    ASSERT_EQUAL(get_names(book.FindByNamePrefix("Vasilis")),
                 (vector<string>{"Vasilisa Kuznetsova"}));
    ASSERT_EQUAL(
            get_names(book.FindByNamePrefix("")),
            (vector<string>{"", "Ivan Ivanov", "Ivan Petrov", "Ivan Vasiliev",
                            "Vasilisa Kuznetsova", "Vasiliy Ivanov", "Vasiliy Petrov",
...
void TestFindNameByPrefix2() {
    ...
    ASSERT_EQUAL(get_names(book.FindByNamePrefix("aa")),
    ...
    ASSERT_EQUAL(get_names(book.FindByNamePrefix("aaa")),
                 (vector<string>{"aaaa"}));
    ASSERT_EQUAL(get_names(book.FindByNamePrefix("ae")),
