...
ResponseType Data_Structure::DataBaseYellowPages::FindCompanies(const std::vector<std::shared_ptr<Query>> &queries) {
    ...
    return std::make_shared<CompaniesResponse>(
            std::vector<const YellowPages::Company *>{companies.begin(), companies.end()});
}

void
Data_Structure::NameQuery::Compare(std::list<const YellowPages::Company *> &companies, struct DataBaseYellowPages *) {
    if (names.empty())
        return;
...
void
Data_Structure::UrlQuery::Compare(std::list<const YellowPages::Company *> &companies, struct DataBaseYellowPages *) {
    if (urls.empty())
        return;
...
void Data_Structure::RubricQuery::Compare(std::list<const YellowPages::Company *> &companies,
                                          struct DataBaseYellowPages *db) {
    if (rubrics.empty())
        return;
...
void
Data_Structure::PhoneQuery::Compare(std::list<const YellowPages::Company *> &companies, struct DataBaseYellowPages *) {
    if (phones.empty())
        return;
