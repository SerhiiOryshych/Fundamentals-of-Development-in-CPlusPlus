...
public:
    ...
    double ComputeWalkTime(double distance) const;
    ...
    void DebugNotFoundRoute(const YellowPages::CompanyQuery &query) const;
...
private:
    ...
    mutable YellowPages::Database yellow_pages_db_;
